"""
BC + Gradual Curriculum + 2M steps per phase (10M total).

ent_coef=0.1 (paper), 2M steps/phase, SubprocVecEnv for speed.
"""
...
def main():
    ...
    print(f"Device: {device}, N_ENVS: {N_ENVS}, steps/phase: {STEPS_PER_PHASE:,}")
    ...
    for phase_idx, (t_prep, t_exec, rlf, pp, lr, label) in enumerate(PHASES):
        ...
        print(f"  steps={STEPS_PER_PHASE:,}, ent={PPO_ENT_COEF}, n_envs={N_ENVS}")
        print("=" * 60)
